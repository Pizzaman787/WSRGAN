...
square1Middle = int((square1Size / 2)) #might have to subtract 1 from this to ensure it is actually at the center for indexing

square1 = np.zeros((square1Size, square1Size, 4), dtype = np.uint8) # set to zero so uninitiated pixels are transparent
